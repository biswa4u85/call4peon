...
class Authenticate {
    ...
    protected function authenticate() {
        $front_allow_arrray = array('index', 'logout', 'signup', 'signup_action', 'signin', 'signin_action', 'userEmail', 'forgot_password', 'forgot_password_action', 'verification', 'signout', 'staticpage', 'search', 'forgotEmailExist', 'reset_pass', 'resetpass_action', 'serviceAuth','getMailbox','payment');
        ...
        $class_allow_arrray = array('content');
